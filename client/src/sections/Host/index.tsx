    ...
    return (
        <Content className="host-content">
            <Form layout="vertical" onFinish={handleHostListing} form={form}>
                ...
                >
                    <Radio.Group>
                        <Radio.Button value={ListingType.LAPTOP}>
                            <Icon type="bank" style={{ color: iconColor }} />{" "}
                            <span>Laptop</span>
                        </Radio.Button>
                        <Radio.Button value={ListingType.ELECTRONICS}>
                ...
                >
                    <Input.TextArea
                        rows={3}
                        maxLength={400}
                        placeholder="Modern, clean, and Simple to carry around!"
                    />
                </Form.Item>
